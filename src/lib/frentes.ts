...
const holding: Frente = {
  ...
  facts: [
    ...
    { lbl: 'Formação', val: 'Especialização em <em>Holdings</em> · Holding Masters' },
    { lbl: 'Ticket', val: 'Projetos <em>consultivos</em>, escopo por caso' },
  ],
  ...
  signs: [
    { idx: '01', titulo: 'Sucessão patrimonial a organizar', texto: 'Patrimônio consolidado com herdeiros definidos, com benefício real em antecipar a transmissão via doação com reserva de usufruto, reduzir ITCMD e evitar inventário.' },
    { idx: '02', titulo: 'Participações societárias a proteger', texto: 'Empresário com participação em sociedades operacionais que precisa separar patrimônio pessoal do operacional, organizar fluxo de dividendos e construir blindagem lícita.' },
  ...
  faqs: [
    ...
    { pergunta: 'O que é lucro presumido em holding — e quando se aplica?', resposta: 'Regime em que o lucro tributável é calculado por presunção sobre a receita bruta. Em holdings com fluxo imobiliário ou de participações, pode ser <em>consideravelmente mais eficiente</em> que o lucro real — mas tem limites e exigências próprias.' },
...
const govFamiliar: Frente = {
  ...
  faqs: [
    ...
    { pergunta: 'A família precisa estar em conflito para começar?', resposta: 'Ao contrário — o momento ideal é na harmonia. Governança em harmonia é construção; em conflito aberto é mediação. Ambas possíveis, mas a primeira é consideravelmente mais eficiente.' },
